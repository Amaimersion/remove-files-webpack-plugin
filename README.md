...
|  TestObject.method   | `(filePath: string) => boolean` | Required |         A method that accepts file path (`root` + directoryPath + fileName) and<br>returns value that indicates should this file be removed or not.         |
