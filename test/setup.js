...
const FOLDERS = [
    ...
    path.resolve('.', 'acceptance_test_remove/dist4/styles/test1/test2'),
    path.resolve('.', 'acceptance_test_remove/dist5/styles/test 1'),
    path.resolve('.', 'acceptance_test_remove/dist5/scripts/test 1/test 2'),
    ...
    path.resolve('.', 'acceptance_test_remove/dist8/test test'),
    path.resolve('.', 'acceptance_test_remove/dist9/js'),
    path.resolve('.', 'acceptance_test_remove/dist10/dist1'),
    path.resolve('.', 'acceptance_test_remove/dist10/dist2/js'),
    path.resolve('.', 'acceptance_test_remove/dist10/dist3/test'),
...
const FILES = [
    ...
    path.resolve('.', 'acceptance_test_remove/dist3/manifest.json'),
    path.resolve('.', 'acceptance_test_remove/dist3/test.txt'),
    path.resolve('.', 'acceptance_test_remove/dist3/maps/test.txt'),
    path.resolve('.', 'acceptance_test_remove/dist4/test.txt'),
    path.resolve('.', 'acceptance_test_remove/dist4/styles/1.map'),
    path.resolve('.', 'acceptance_test_remove/dist4/styles/1.map.css'),
    path.resolve('.', 'acceptance_test_remove/dist4/styles/test1/1.map'),
    path.resolve('.', 'acceptance_test_remove/dist4/styles/test1/test.txt'),
    path.resolve('.', 'acceptance_test_remove/dist4/styles/test1/test2/test file.map'),
    path.resolve('.', 'acceptance_test_remove/dist4/styles/test1/test2/test.txt'),
    path.resolve('.', 'acceptance_test_remove/dist5/test.txt'),
    path.resolve('.', 'acceptance_test_remove/dist5/styles/1.css.map'),
    path.resolve('.', 'acceptance_test_remove/dist5/styles/1.css'),
    path.resolve('.', 'acceptance_test_remove/dist5/styles/test 1/1.css.map'),
    path.resolve('.', 'acceptance_test_remove/dist5/styles/test 1/1.css'),
    path.resolve('.', 'acceptance_test_remove/dist5/scripts/1.js.map'),
    path.resolve('.', 'acceptance_test_remove/dist5/scripts/1.js'),
    path.resolve('.', 'acceptance_test_remove/dist5/scripts/test 1/1.js.map'),
    path.resolve('.', 'acceptance_test_remove/dist5/scripts/test 1/1.js'),
    path.resolve('.', 'acceptance_test_remove/dist5/scripts/test 1/test 2/1.js.map'),
    path.resolve('.', 'acceptance_test_remove/dist5/scripts/test 1/test 2/1.js'),
    path.resolve('.', 'acceptance_test_remove/dist6/test.txt'),
    path.resolve('.', 'acceptance_test_remove/dist6/maps/1.map.js'),
    path.resolve('.', 'acceptance_test_remove/dist6/maps/2.map.js'),
    path.resolve('.', 'acceptance_test_remove/dist6/maps/main.map.js'),
    path.resolve('.', 'acceptance_test_remove/dist6/maps/test/1.map.js'),
    path.resolve('.', 'acceptance_test_remove/dist6/styles/1.css'),
    path.resolve('.', 'acceptance_test_remove/dist6/styles/1.css.map'),
    path.resolve('.', 'acceptance_test_remove/dist6/styles/popup.css'),
    path.resolve('.', 'acceptance_test_remove/dist6/styles/popup.css.map'),
    path.resolve('.', 'acceptance_test_remove/dist6/styles/test/1.css'),
    path.resolve('.', 'acceptance_test_remove/dist6/styles/test/1.css.map'),
    ...
    path.resolve('.', 'acceptance_test_remove/dist9/js/entry.js'),
    path.resolve('.', 'acceptance_test_remove/dist10/dist2/js/test.js'),
    path.resolve('.', 'acceptance_test_remove/dist10/dist2/js/test-nvsdl1234.js'),
    path.resolve('.', 'acceptance_test_remove/dist10/dist3/log.txt'),
    path.resolve('.', 'acceptance_test_remove/dist10/dist3/test.txt'),
